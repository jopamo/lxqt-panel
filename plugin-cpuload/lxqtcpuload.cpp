/* plugin-cpuload/lxqtcpuload.cpp
 * Implementation file for lxqtcpuload
 */
...
void LXQtCpuLoad::settingsChanged() {
  ...
  QString barOrientation =
      mPlugin->settings()->value(QStringLiteral("barOrientation"), QStringLiteral(BAR_ORIENT_BOTTOMUP)).toString();
