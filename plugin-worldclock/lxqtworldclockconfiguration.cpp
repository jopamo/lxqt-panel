...
LXQtWorldClockConfiguration::LXQtWorldClockConfiguration(PluginSettings* settings, QWidget* parent)
  ...
  connect(ui->timeZonesTW, &QTableWidget::itemSelectionChanged, this,
          &LXQtWorldClockConfiguration::updateTimeZoneButtons);
...
void LXQtWorldClockConfiguration::customiseManualFormatClicked() {
  if (!mConfigurationManualFormat) {
    ...
    connect(mConfigurationManualFormat, &LXQtWorldClockConfigurationManualFormat::manualFormatChanged, this,
            &LXQtWorldClockConfiguration::manualFormatChanged);
  }
