/* plugin-volume/1g4-mixer/src/sinkwidget.cc
 * Implementation of sinkwidget.cc
 */
...
SinkWidget::SinkWidget(MainWindow* parent) : DeviceWidget(parent, "sink") {
#if HAVE_EXT_DEVICE_RESTORE_API
  uint8_t i = 0;
...
void SinkWidget::onEncodingsChange() {
  ...
  if (!(o = pa_ext_device_restore_save_formats(get_context(), PA_DEVICE_TYPE_SINK, index, n_formats, formats, nullptr,
                                               nullptr))) {
