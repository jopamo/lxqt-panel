/* plugin-volume/1g4-mixer/src/streamwidget.cc
 * Implementation of streamwidget.cc
 */
...
StreamWidget::StreamWidget(MainWindow* parent)
    : MinimalStreamWidget(parent), mpMainWindow(parent), terminate{new QAction{tr("Terminate"), this}} {
  setupUi(this);
