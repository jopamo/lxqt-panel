/* plugin-fancymenu/lxqtfancymenuappmodel.cpp
...
LXQtFancyMenuAppModel::LXQtFancyMenuAppModel(QObject* parent)
    : QAbstractListModel(parent), mAppMap(nullptr), mCurrentCategory(0), mInSearch(false) {}
...
bool LXQtFancyMenuAppModel::dropMimeData(const QMimeData* data_,
