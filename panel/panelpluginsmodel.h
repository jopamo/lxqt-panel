...
class PanelPluginsModel : public QAbstractListModel {
  Q_OBJECT
 public:
  PanelPluginsModel(OneG4Panel* panel,
 ...
 public slots:
   ...
   */
  void addPlugin(OneG4Panel* panel, const OneG4::PluginInfo& desktopFile);
  /*!
   ...
   * IOneG4PanelPlugin::HaveConfigDialog), this method shows
  ...
  */
  ...
  /*!
   * \brief mPanelSettings Stores a reference to settings of OneG4Panel.
   */
  OneG4::Settings* mPanelSettings;
};
