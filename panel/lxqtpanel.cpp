...
void LXQtPanel::updateStyleSheet() {
  ...
  if (QFileInfo::exists(mBackgroundImage))
    sheet << QString(QStringLiteral("LXQtPanel #BackgroundWidget { background-image: url('") + mBackgroundImage +
                     QStringLiteral("');}"));
...
QRect LXQtPanel::calculatePopupWindowPos(const ILXQtPanelPlugin* plugin, const QSize& windowSize) const {
  ...
  // assuming there are no contentMargins around the "BackgroundWidget" (LXQtPanelWidget)
