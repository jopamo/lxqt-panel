...
class PluginSettingsPrivate {
 public:
  PluginSettingsPrivate(LXQt::Settings* settings, const QString& group) : mSettings(settings), mGroup(group) {
...
PluginSettings* PluginSettingsFactory::create(LXQt::Settings* settings,
                                              const QString& group,
