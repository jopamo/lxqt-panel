...
void ConfigPlacement::fillComboBox_alignment() {
  ...
  if (mPosition == ILXQtPanel::PositionTop || mPosition == ILXQtPanel::PositionBottom) {
...
void ConfigPlacement::editChanged() {
  ...
  LXQtPanel::Alignment align =
      LXQtPanel::Alignment(ui->comboBox_alignment->itemData(ui->comboBox_alignment->currentIndex()).toInt());
...
void ConfigPlacement::positionChanged() {
  ...
  bool updateAlig = (sp.position == ILXQtPanel::PositionTop || sp.position == ILXQtPanel::PositionBottom) !=
                    (mPosition == ILXQtPanel::PositionTop || mPosition == ILXQtPanel::PositionBottom);
