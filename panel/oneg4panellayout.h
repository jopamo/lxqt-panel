/* panel/oneg4panellayout.h
 * Main panel implementation, window management
 */

#ifndef ONEG4PANELLAYOUT_H
#define ONEG4PANELLAYOUT_H
...
class ONEG4_PANEL_API OneG4PanelLayout : public QLayout {
  Q_OBJECT
 public:
  explicit OneG4PanelLayout(QWidget* parent);
  ~OneG4PanelLayout();
  ...
  void setPosition(IOneG4Panel::Position value);
