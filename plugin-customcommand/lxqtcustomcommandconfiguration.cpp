/* plugin-customcommand/lxqtcustomcommandconfiguration.cpp
 * Configuration implementation for plugin-customcommand
 */
...
#define HELP_STRUC_DESC1              \
  LXQtCustomCommandConfiguration::tr( \
      "command outputs structured variables to be used for button visualization in form of:")
...
#define HELP_STRUC_DESC5 \
  LXQtCustomCommandConfiguration::tr("icon to be shown in the button, in the same form as explained before")
...
const QStringList LXQtCustomCommandConfiguration::msOutputFormatStrings = {QStringLiteral(QT_TR_NOOP("Text only")),
...
LXQtCustomCommandConfiguration::LXQtCustomCommandConfiguration(PluginSettings* settings, QWidget* parent)
  ...
  mHelpText =
      QStringLiteral(
          "<html><head/><body><p><span style=\" font-weight:700;\">%1</span> - %2</p>"
          ...
          "<p><span style=\" font-weight:700;\">%12</span> - %13 \"<span style=\" text-decoration: "
          "underline;\">%14</span>\".<br/>"
          "%15<br/>"
          ...
          "%20<br/>"
          "<span style=\" font-style:italic;\">echo \"text:$(echo -n \"%21\" | base64 --wrap=0) icon:$(base64 --wrap=0 "
          "%22.svg) tooltip:$(echo -n \"%23\" | base64 --wrap=0)\"</span></p></body></html>")
          .arg(msOutputFormatStrings[OUTPUT_TEXT], HELP_TEXT_DESC, msOutputFormatStrings[OUTPUT_ICON], HELP_ICON_DESC1,
               HELP_ICON_DESC2, HELP_ICON_DESC3, HELP_ICON_DESC4, HELP_ICON_DESC5, HELP_ICON_DESC6, HELP_ICON_DESC7,
               HELP_ICON_DESC8, msOutputFormatStrings[OUTPUT_STRUCTURED], HELP_STRUC_DESC1, HELP_STRUC_DESC2,
               HELP_STRUC_DESC3, HELP_STRUC_DESC4, HELP_STRUC_DESC5, HELP_STRUC_DESC6, HELP_STRUC_DESC7,
               HELP_STRUC_DESC8, HELP_STRUC_EXAMPLE1, HELP_STRUC_EXAMPLE2, HELP_STRUC_EXAMPLE3);
  ...
  connect(ui->textColorResetButton, &QPushButton::clicked, this,
          &LXQtCustomCommandConfiguration::textColorResetButtonClicked);
  connect(ui->commandPlainTextEdit, &QPlainTextEdit::textChanged, this,
          &LXQtCustomCommandConfiguration::commandPlainTextEditChanged);
  connect(ui->runWithBashCheckBox, &QCheckBox::toggled, this,
          &LXQtCustomCommandConfiguration::runWithBashCheckBoxChanged);
  connect(ui->outputFormatComboBox, &QComboBox::currentIndexChanged, this,
          &LXQtCustomCommandConfiguration::outputFormatComboBoxChanged);
  connect(ui->continuousOutputCheckBox, &QCheckBox::toggled, this,
          &LXQtCustomCommandConfiguration::continuousOutputCheckBoxChanged);
  connect(ui->repeatCheckBox, &QCheckBox::toggled, this, &LXQtCustomCommandConfiguration::repeatCheckBoxChanged);
  connect(ui->repeatTimerSpinBox, &QSpinBox::editingFinished, this,
          &LXQtCustomCommandConfiguration::repeatTimerSpinBoxChanged);
  ...
  connect(ui->tooltipLineEdit, &QLineEdit::editingFinished, this,
          &LXQtCustomCommandConfiguration::tooltipLineEditChanged);
  connect(ui->maxWidthSpinBox, &QSpinBox::editingFinished, this,
          &LXQtCustomCommandConfiguration::maxWidthSpinBoxChanged);
  connect(ui->clickLineEdit, &QLineEdit::editingFinished, this, &LXQtCustomCommandConfiguration::clickLineEditChanged);
  connect(ui->wheelUpLineEdit, &QLineEdit::editingFinished, this,
          &LXQtCustomCommandConfiguration::wheelUpLineEditChanged);
  connect(ui->wheelDownLineEdit, &QLineEdit::editingFinished, this,
          &LXQtCustomCommandConfiguration::wheelDownLineEditChanged);
  connect(ui->helpToolButton, &QToolButton::clicked, this,
          [this]() { QWhatsThis::showText(QCursor::pos(), mHelpText, this); });
}
...
void LXQtCustomCommandConfiguration::loadSettings() {
  ...
  ui->commandPlainTextEdit->setPlainText(
      settings().value(QStringLiteral("command"), QStringLiteral("echo Configure...")).toString());
  ...
  if (settings().contains(QStringLiteral("outputFormat")))
    ui->outputFormatComboBox->setCurrentIndex(
        ui->outputFormatComboBox->findData(settings().value(QStringLiteral("outputFormat")).toInt()));
  else {
...
void LXQtCustomCommandConfiguration::iconBrowseButtonClicked() {
  QString fileName =
      QFileDialog::getOpenFileName(this, tr("Select Icon File"), QString(), tr("Images (*.png *.svg *.xpm *.jpg)"));
